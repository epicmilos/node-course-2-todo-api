...
describe('POST /todos', () => {
  it('it should create a new todo', (done) => { //callback function with done argument
    ...
    request(app)
      .post('/todos')
      .set('x-auth', users[0].tokens[0].token)// in order to send data with the request we call .send
...
describe('GET /todos/:id', () => {
  it('should return todo doc', (done) => {
    request(app)
      ...
      .set('x-auth', users[0].tokens[0].token)//we use toHexString to convert ObjectID  into a string.
      .expect(200)
      .expect((res) => {
...
describe('PATCH/todos/:id',()=>{
  ...
  it('should not update the todo created as dif. user',(done)=>{
    var hexId = todos[0]._id.toHexString();
    var text = 'This should be the new text';
...
describe('POST /users',()=>{
  it('shoudl create a user', (done)=>{
    var email = 'primer@primer.com';
    var password = 'testprimera';
